...
pub struct InternalTargetsRecursionlessTree<T: LinkReference> {
    base: InternalRecursionlessSizeBalancedTreeBase<T>,
}

impl<T: LinkReference> InternalTargetsRecursionlessTree<T> {
    pub fn new(
...
impl<T: LinkReference> RecursiveSizeBalancedTree<T> for InternalTargetsRecursionlessTree<T> {
...
impl<T: LinkReference> IterativeSizeBalancedTree<T> for InternalTargetsRecursionlessTree<T> {}
...
impl<T: LinkReference> LinksTree<T> for InternalTargetsRecursionlessTree<T> {
...
impl<T: LinkReference> SplitUpdateMem<T> for InternalTargetsRecursionlessTree<T> {
...
impl<T: LinkReference> SplitTree<T> for InternalTargetsRecursionlessTree<T> {}
