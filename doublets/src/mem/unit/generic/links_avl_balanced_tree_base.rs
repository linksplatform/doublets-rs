...
/// AVL Balanced Tree base implementation for links
pub struct LinksAvlBalancedTreeBase<T: LinkType> {
...
impl<T: LinkType> LinksAvlBalancedTreeBase<T> {
...
/// Abstract trait for AVL balanced tree operations on links
pub trait LinkAvlBalancedTreeBaseAbstract<T: LinkType>:
    AvlTree<T> + LinksTree<T>
{
