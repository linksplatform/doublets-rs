...
pub struct LinksSourcesRecursionlessSizeBalancedTree<T: LinkType + crate::TreesLinkType> {
    base: LinksRecursionlessSizeBalancedTreeBase<T>,
}

impl<T: LinkType + crate::TreesLinkType> LinksSourcesRecursionlessSizeBalancedTree<T> {
...
impl<T: LinkType + crate::TreesLinkType> RecursiveSizeBalancedTree<T> for LinksSourcesRecursionlessSizeBalancedTree<T> {
...
impl<T: LinkType + crate::TreesLinkType> IterativeSizeBalancedTree<T> for LinksSourcesRecursionlessSizeBalancedTree<T> {}
...
impl<T: LinkType + crate::TreesLinkType> LinksTree<T> for LinksSourcesRecursionlessSizeBalancedTree<T> {
...
impl<T: LinkType + crate::TreesLinkType> UnitUpdateMem<T> for LinksSourcesRecursionlessSizeBalancedTree<T> {
...
impl<T: LinkType + crate::TreesLinkType> UnitTree<T> for LinksSourcesRecursionlessSizeBalancedTree<T> {}
